...
export function WhyChoose() {
  ...
  return (
    <section id="servicii" className="relative bg-ink py-20 text-white lg:py-28">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-4 md:grid-rows-2">
          <Reveal delay={0.05} className="md:col-span-2 md:row-span-2">
            <div className="flex h-full flex-col justify-between rounded-3xl border border-white/10 bg-white/[0.04] p-8">
              <div>
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-teal-500/15 text-teal-300">
                  01
                </span>
          ...
          <Reveal delay={0.1} className="md:col-span-2">
            <div className="h-full rounded-3xl bg-teal-500 p-7 text-white">
        ...
        <Reveal delay={0.1}>
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {SITE.services.map((service) => (
              <div
                key={service.title}
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition-colors hover:bg-white/[0.07]"
              >
                <h4 className="font-display text-base font-semibold">{service.title}</h4>
